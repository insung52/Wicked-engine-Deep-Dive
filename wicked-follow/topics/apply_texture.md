...
> | 문서 | 내용 |
> |------|------|
> | [part3 § 3.8 — DXGI_USAGE, RTV vs SRV, 중간 RT 패턴](../../study/graphics/part3_gpu_communication.md) | 스왑체인 기초 개념 |
...
> **⚠️ VizMotive 적용 판단 필요**
> VizMotive의 현재 렌더링 파이프라인은 backbuffer를 셰이더에서 읽는 코드가 없다.
> (Tonemap → Compute UAV → 중간 RT → Graphics blit → swapchain RTV 방식)
> 이 변경의 실제 효과와 적용 범위는 `appendix_vizmotive_swapchain.md` 참고.
