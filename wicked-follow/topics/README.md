...
| 주제 | 분석 | VizMotive 적용 | PDF | 관련 커밋 수 | PR 적용 완료 |
|------|------|----------------|-----|-------------|-------------|
...
| CopyAllocator | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_copy_allocator.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_copy_allocator.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/copy_allocator.pdf) | 3개 | ✅ merged |
| Custom Allocator & shared_ptr | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_allocator_shared_ptr.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_allocator_shared_ptr.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/allocator_shared_ptr.pdf) | 11개 | ✅ merged |
| Texture Operations | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_texture.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_texture.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/texture.pdf) | 5개 | — |
| PSO & Root Signature | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_pso_rootsig.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_pso_rootsig.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/pso_rootsig.pdf) | 4개 | — |
| Struct Optimization | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_struct_optimization.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_struct_optimization.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/struct_optimization.pdf) | 2개 | — |
| Bug Fixes & Stability | [topic](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/topic_bug_fixes.md) | [apply](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/apply_bug_fixes.md) | [pdf](https://github.com/insung52/Wicked-engine-Deep-Dive/blob/main/wicked-follow/topics/pdf/bug_fixes.pdf) | 6개 | — |
